...
df = pd.read_csv('data/volcano/match_neg2.csv',delimiter=',')
df_filter = df[df['delta_mass(ppm)'] <= 10]
#print(df_filter.columns)
# print accesion number
print(df_filter.shape)
# read in the volcano data
df_sample = pd.read_csv('data/volcano/Feature_SI_neg.csv')
...
# save to csv file
df_filter_unique_extract.to_csv('data/Feature/CompoundList_neg.csv', index=False)